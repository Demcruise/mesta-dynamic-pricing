...
import idData from './id/data.json';
import enExceptions from './en/exceptions.json';
import idExceptions from './id/exceptions.json';
import enAlerts from './en/alerts.json';
import idAlerts from './id/alerts.json';
import enCompetitors from './en/competitors.json';
