...
import { activateStrategy, archiveStrategy, rejectStrategy, submitStrategy } from '@/lib/actions/strategy';
...
const STATUS_ORDER: StrategyStatus[] = ['active', 'pending_manager_approval', 'draft', 'archived'];
